        ...
        <footer className="w-full border-t bg-background py-12 md:py-16">
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li><Link href="/services#mobile" className="hover:text-foreground transition-colors">Mobile Applications</Link></li>
                            <li><Link href="/services#ai" className="hover:text-foreground transition-colors">AI & ML Solutions</Link></li>
                            <li><Link href="/services#saas" className="hover:text-foreground transition-colors">SaaS Platforms</Link></li>
                        </ul>
                    </div>
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            ...
                            <li><Link href="/portfolio" className="hover:text-foreground transition-colors">Our Portfolio</Link></li>
                ...
                <div className="mt-12 flex flex-col md:flex-row items-center justify-between border-t pt-8 text-xs text-muted-foreground">
                    <p>© {new Date().getFullYear()} Zentrix Technologies. All rights reserved.</p>
